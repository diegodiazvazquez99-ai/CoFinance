...
// HOMEVIEW COMPLETO CON TOOLBAR MEJORADO

import SwiftUI
import Combine
import CoreData

// MARK: - HOME VIEW CON TOOLBAR AVANZADO
struct HomeView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            // 🚀 TOOLBAR MEJORADO CON TÍTULO CENTRADO
            .toolbar {
                // LEADING: Avatar/Profile Menu
                ToolbarItem(placement: .navigationBarLeading) {
                    Menu {
                        // Información del usuario
                        Section {
                            Label("Usuario CoFinance", systemImage: "person.circle")
                            Label("Versión 1.0", systemImage: "info.circle")
                        }
                        ...
                        Section("Acciones Rápidas") {
                            Button(action: {
                                ...
                                Label("Ver cuentas", systemImage: "creditcard")
                            }
                            
                            Button(action: {
                                selectedTab = .transactions
                            }) {
                                Label("Ver transacciones", systemImage: "list.bullet.rectangle")
                            }
                            
                            Button(action: {
                                selectedTab = .subscriptions
                            }) {
                                Label("Ver suscripciones", systemImage: "repeat.circle")
                            }
                        }
                ...
                // PRINCIPAL: Título CoFinance centrado
                ...
                // TRAILING: Grupo de acciones principales
            ...
            // 🎨 TOOLBAR STYLING MODERNO - TRANSPARENTE DURANTE SCROLL
            ...
            VStack(spacing: 12) {
                ...
                if totalBalance < 0 {
                    ...
                    HStack {
                        ...
                        Text("Balance negativo - Revisa tus gastos")
                            .font(.caption)
                            .foregroundColor(.orange)
                        Spacer()
                    }
