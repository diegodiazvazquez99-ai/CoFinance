...
struct Transaction: Identifiable, Codable {
    ...
    // MARK: - Formateo con SettingsManager
    func formattedAmount(with settings: SettingsManager) -> String {
        let sign = isIncome ? "+" : ""
        return sign + settings.formatCurrency(abs(amount))
    }
    
    // MARK: - Formateo legacy (mantenido por compatibilidad)
