...
extension Date {
    ...
    /// Mes y año capitalizado manualmente
    var monthYearCapitalized: String {
        let monthYear = DateFormatter.monthYear.string(from: self)
        return monthYear.prefix(1).uppercased() + monthYear.dropFirst()
    }
}
